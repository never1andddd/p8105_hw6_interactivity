...
The Git repo containing the solution to this problem is [here](https://github.com/zxinxinz/P8105_hw6-dashboard)


### Git repo 

The Git repo containing the solution to these problems is
